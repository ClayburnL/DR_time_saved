...
function [] = Append2xls_v5(scanner, protocol, seq_name, seq_time, DR_seq, original_seq, DR_seq_time, original_seq_time, time_saving, time_saving_percent, protocol_time_saving, protocol_time_saving_percent)
    ...
    if ~isfile(filename)
        ...
        writecell(heading,filename,'Sheet',2, 'WriteMode','append');
        writecell(heading2,filename,'Sheet', 2, 'WriteMode','append');
    end
    ...
    date_cell=cell(1,1);
    date_cell{1}=date;
    writecell(date_cell,filename,'Sheet',2, 'WriteMode','append');
    writecell(protocol,filename,'Sheet',2, 'WriteMode','append');
    ...
    writecell(result,filename,'Sheet',2, 'WriteMode','append');
